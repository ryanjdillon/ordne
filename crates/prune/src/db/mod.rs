...
impl DriveRole {
    ...
    pub fn from_str(s: &str) -> Result<Self> {
        match s {
            ...
            _ => Err(PruneError::Config(format!("Invalid drive role: {}", s))),
        }
    }
}
...
impl Backend {
    ...
    pub fn from_str(s: &str) -> Result<Self> {
        match s {
            ...
            _ => Err(PruneError::InvalidBackend(s.to_string())),
        }
    }
}
...
impl FileStatus {
    ...
    pub fn from_str(s: &str) -> Result<Self> {
        match s {
            ...
            _ => Err(PruneError::Config(format!("Invalid file status: {}", s))),
        }
    }
}
...
impl Priority {
    ...
    pub fn from_str(s: &str) -> Result<Self> {
        match s {
            ...
            _ => Err(PruneError::Config(format!("Invalid priority: {}", s))),
        }
    }
}
...
impl PlanStatus {
    ...
    pub fn from_str(s: &str) -> Result<Self> {
        match s {
            ...
            _ => Err(PruneError::Config(format!("Invalid plan status: {}", s))),
        }
    }
}
...
impl StepAction {
    ...
    pub fn from_str(s: &str) -> Result<Self> {
        match s {
            ...
            _ => Err(PruneError::Config(format!("Invalid step action: {}", s))),
        }
    }
}
...
impl StepStatus {
    ...
    pub fn from_str(s: &str) -> Result<Self> {
        match s {
            ...
            _ => Err(PruneError::Config(format!("Invalid step status: {}", s))),
        }
    }
}
...
impl Database for SqliteDatabase {
    ...
    fn update_drive_online_status(&mut self, label: &str, is_online: bool) -> Result<()> {
        ...
        if rows == 0 {
            return Err(PruneError::DriveNotFound(label.to_string()));
        }
        Ok(())
    }
